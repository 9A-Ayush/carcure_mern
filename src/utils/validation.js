export const validatePhone = (phone) => {
  const phoneRegex = /^\+91[0-9]{10}$/;  // Updated to match +91 followed by 10 digits
  if (!phone) return "Phone number is required";
  if (!phoneRegex.test(phone)) return "Please enter a valid phone number in format: +91 followed by 10 digits";
  return "";
};
